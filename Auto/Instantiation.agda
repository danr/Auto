...
inst-zero-correct (e₁ [ b ] e₂) Γ = inst-zero-correct e₁ Γ ⟨ cong₂ (B-eval b) ⟩ inst-zero-correct e₂ Γ
inst-zero-correct (u ∙ e)       Γ = cong (U-eval u) (inst-zero-correct e Γ)
...
inst-suc-correct k (e₁ [ b ] e₂) Γ = inst-suc-correct k e₁ Γ ⟨ cong₂ (B-eval b) ⟩ inst-suc-correct k e₂ Γ
inst-suc-correct k (u ∙ e)       Γ = cong (U-eval u) (inst-suc-correct k e Γ)
