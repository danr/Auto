...
data Lemma : Set where
  lem : (n : ℕ) (lhs rhs : Expr n) (eq : Equality lhs rhs) → Lemma
...
data Trace : Set where
    first-var-ind apply                         : Trace → Trace → Trace
    reshuffle step-suc                          : Trace → Trace
    refl step-match-IH step-sides-match noTrace : Trace
